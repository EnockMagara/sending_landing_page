      ...
      <div className="relative overflow-hidden flex flex-col items-center justify-center h-screen text-center">
        ...
        <div className="relative mx-auto max-w-4xl px-6 pt-32 pb-24 lg:pt-48 lg:pb-32">
          <h1 className="text-5xl font-extrabold leading-tight tracking-tight sm:text-7xl text-[rgb(242,245,249)] font-poppins">
            Your AI walking companion.<br/>
            <span className="text-[rgb(227,173,125)]">Always watching. Always guiding.</span>
          </h1>
          <p className="mt-6 max-w-2xl mx-auto text-lg text-[rgb(242,245,249)] font-montserrat">
            Talk to Seer. It listens. It sees. It guides. Real-time object detection meets conversational AI to create a living, breathing navigation companion that understands your world—and warns you with haptic feedback the instant danger appears.
          </p>
          ...
          <div className="mt-10 flex justify-center">
            <div className="relative group">
              ...
              {/* Main badge */}
              <div className="relative bg-[rgb(16,16,12)] border-2 border-blue-500/40 rounded-2xl px-8 py-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="border-l border-blue-500/30 pl-4">
                    <div className="text-xs text-blue-400 uppercase tracking-widest font-semibold mb-1 font-poppins">
                      Entirely Generated by
                    </div>
                    <div className="text-xl font-bold text-[rgb(242,245,249)] font-poppins">
                      Cursor AI
                    </div>
                    <div className="text-xs text-purple-400 font-semibold flex items-center gap-2 mt-1 font-montserrat">
                      <span className="inline-block w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
                      Not a single line of human intervention
                    </div>
                  </div>
                  <div className="border-l border-blue-500/30 pl-4">
                    <div className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 font-poppins">
                      100%
                    </div>
                    <div className="text-xs text-[rgb(242,245,249)]/70 font-montserrat">
                      AI Generated
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-8 flex flex-col items-center gap-4">
            ...
            <a 
              ...
              className="flex items-center justify-center gap-2 rounded-md border-2 border-[rgb(227,173,125)] px-6 py-3 text-lg font-semibold text-[rgb(227,173,125)] hover:bg-[rgb(227,173,125)] hover:text-[rgb(16,16,12)] transition-all duration-300 font-montserrat"
            >
          ...
          {/* Secondary Cursor Badge - Small footer */}
          <div className="mt-8 text-center">
            <div className="inline-flex items-center gap-2 text-sm text-[rgb(242,245,249)]/60 font-montserrat">
              <span>⚡</span>
              <span>Built end-to-end with</span>
              <Image
                src="/Cursor_logo.png"
                alt="Cursor"
                width={16}
              ...
              />
              <span className="font-semibold text-blue-400">Cursor AI</span>
              <span>•</span>
              <span className="text-green-400">100% autonomous code generation</span>
            </div>
          </div>
        </div>
      </div>
